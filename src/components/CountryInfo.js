        ...
        <div>
            ...
            <div className="row">
                <div className="dataRow">
                    <h4>Borders:</h4>
                    <span>
                        {(countryData.borders) ? Object.values(countryData.borders).toString().split(",").join(", ") : "N/A"}
                    </span>
                </div>
            </div>
            <div className="row">
                <div className="dataRow">
                    <h4>Area:</h4>
                    <span>{countryData.area} km<sup>2</sup></span>
                </div>
            </div>
            <div className="row">
                <div className="dataRow">
            ...
            <div className="row">
                <div className="dataRow">
                    <h4>Capital Latitudes and Logitudes are:</h4>
            ...
            <div className="row">
                <div className="dataRow">
                    <h4>TimeZones:</h4>
                    <span>
                        {Object.values(countryData.timezones).toString().split(",").join(", ")}
                    </span>
                </div>
